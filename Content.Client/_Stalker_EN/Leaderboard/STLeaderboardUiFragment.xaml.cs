...
{
    private static readonly ISawmill _sawmill = Logger.GetSawmill("st.leaderboard");
    ...
    public void UpdateState(List<STLeaderboardEntry> entries)
    {
        ...
        {
            // Debug: log why pinned entry is not shown
            _sawmill.Warning($"PinnedContainer not shown: myEntry.HasValue={myEntry.HasValue}, myPosition={myPosition}");
        }
    }
